...
if __name__ == "__main__":
    ...
    # Answer question
    logging.info("Are you satisfied with the best solution? Yes, SGDRegressor converged and provides similar performance to custom GD, with R2 around 0.3. Using a library simplifies implementation while maintaining good results. Note: Hyperparameters were tuned on test set, which may give optimistic results.")