...
- Split: Train/Val/Test (80/10/10) to follow ML best practices
...
- Logs: See logs/part1_trial2.log (each run creates a new trial file)
- Plots: See plots/part1_trial2_mse_vs_iterations.png and plots/part1_trial2_feature_vs_target.png

### Results
- Best params: lr=0.05, iters=2000 (from validation tuning)
- Train MSE: 0.5427
- Val MSE: 0.5097
- Test MSE: 0.5095
- R2: 0.3057
...
- Plots: See plots/part1_trial2_mse_vs_iterations.png and plots/part1_trial2_feature_vs_target.png (feature plot shows all 11 features in 3x4 grid)
